...
export default function Home() {
  ...
  return (
    <>
        ...
        schemaData={[
          ...
          },
          {
            ...
            mainEntity: [
              ...
              { '@type': 'Question', name: 'How do I get started with ScalerHouse?', acceptedAnswer: { '@type': 'Answer', text: 'You can get started by requesting a free growth audit or proposal through our contact page at scalerhouse.com/contact, or by WhatsApp/calling us at +91 91961 31120.' } },
      ...
      <section className="py-12 bg-[#0a1222] border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-slate-500 text-sm font-bold tracking-[4px] uppercase mb-6">Official Agency Partners</p>

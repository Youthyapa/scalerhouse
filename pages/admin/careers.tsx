...
import { Plus, Trash2, ToggleLeft, ToggleRight, Users, DollarSign } from 'lucide-react';
...
const emptyJob = { title: '', department: '', location: 'Remote / Kanpur', type: 'Full-time', salary: '', description: '', requirements: [] as string[] };
                        ...
                        <div key={job._id} className={`glass-card p-5 ${!job.isActive ? 'opacity-50' : ''}`}>
                            <div className="flex justify-between items-start">
                                ...
                                <div className="flex gap-2 items-center ml-4 shrink-0">
                                    ...
                                    <button onClick={() => deleteJob(job._id)} className="p-1.5 rounded text-slate-400 hover:text-red-400 hover:bg-red-400/10" title="Delete">
                                        <Trash2 size={14} />
                                    </button>
                                </div>
                            </div>
